...
{\bfseries\color{primary}LLM 与 AI 辅助开发：}\hspace{0.3em}{\color{darktext}ChatGPT、Claude、DeepSeek、Prompt Engineering、AI Pair Programming 提升开发效率}

\vspace{2pt}

{\bfseries\color{primary}数据库与工程：}\hspace{0.3em}{\color{darktext}MySQL、Git、Linux、Vercel 部署、Markdown / MDX 文档编写}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=2pt]
    \item \textbf{AI 协同开发}：以 Claude / ChatGPT 为结对编程助手，通过精细化 Prompt 设计完成 UI 组件、样式、交互与功能代码生成，显著提升个人开发效率。
    \item \textbf{AI 辅助内容生产}：利用 LLM 辅助文章撰写、大纲整理、代码示例生成与图片描述，熟练掌握与主流 AI 工具高效协作的使用方法。
    \item \textbf{工程化上线}：基于 React + MDX 组件化内容，Git 版本管理与 Vercel 持续部署，域名 \href{https://1001.pp.ua}{1001.pp.ua} 稳定可访问，作为个人技术沉淀与作品展示窗口。
\end{itemize}
...
2026 届本科生，求职方向 AI 应用 / 初级算法。熟悉 Python 与 OpenCV 图像处理，独立完成过拉普拉斯锐化等经典图像增强算法落地；深度使用 Claude、ChatGPT 等主流 LLM 工具，擅长通过 Prompt 工程与 AI Pair Programming 加速开发；具备 MySQL 数据库、Git / Linux 与前端部署能力，可快速进入 AI 应用研发与数据处理工作。
