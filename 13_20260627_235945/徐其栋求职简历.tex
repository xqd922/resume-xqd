...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=2pt]
    \item 以 STM32F103C8T6 为主控，集成光敏 ADC、HC-SR04 超声波、红外感应、SNR8016 离线语音、HC-05 蓝牙、PWM LED、OLED 等 10 个模块，完成硬件选型与焊接调试全流程。
    \item Keil C 模块化开发，模式状态机统一协调自动、手动、远程、语音四种交互；自动模式 ADC 均值滤波分三档 PWM，红外无人关灯，距离 $\leq$ 10cm 蜂鸣器报警。
\end{itemize}
