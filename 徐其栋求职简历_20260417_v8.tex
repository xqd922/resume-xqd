...
{\color{darktext}
\textbf{核心课程：}单片机原理、嵌入式技术、传感器原理、物联网通信、数据库应用、C 语言、数字电子技术
}
...
\textbf{编程语言} & C 语言、Python、C\#（.NET WinForms）\\[3pt]
...
\textbf{开发工具} & Keil MDK、Visual Studio、Git、Linux、嘉立创 EDA
\end{tabular}
...
% ======================== 个人评价（内联紧凑版）========================
{\bfseries\color{primary}\faUser\hspace{0.4em}个人评价}\hspace{0.4em}{\color{darktext}2026 届物联网工程本科生，熟悉 STM32 / ESP32 驱动调试与通信联调，掌握 C\# + MySQL 三层架构上位机与 PCB 设计，能独立完成软硬件联调与功能验证。}
...
\hspace{0.2em}
\tikz{\node[fill=tagbg, rounded corners=3pt, inner sep=4pt, text=tagtext, font=\small\bfseries] {PCB 设计};}
\hspace{0.2em}
