...
{\color{darktext}\textbf{主修课程：}C 语言、Python、单片机原理、嵌入式技术、计算机网络、计算机组成原理、传感器原理、数字电子技术}
...
2026 届物联网工程本科毕业生，具备 3 个嵌入式项目实战经验，熟悉 I2C、UART、MQTT、蓝牙等通信协议，能独立完成硬件选型、驱动调试与功能验证；有工程检测设备开发实习经历，掌握 C/C++ 底层开发与 Git 版本管理，可快速进入嵌入式软件开发岗位。
