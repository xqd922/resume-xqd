...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=2pt]
    \item 参与隧道、桥梁、路面检测设备调试，协助完成传感器信号采集、线路参数检查与设备运行状态监测，排查设备运行中的常见故障，参与软件联调与数据处理流程优化。
    \item 负责实验数据录入、分类汇总与复核，使用 Git 进行技术文档版本管理与迭代；配合项目现场检测工作，了解工程检测流程与嵌入式传感器设备使用规范。
\end{itemize}
