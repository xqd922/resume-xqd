...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=2pt]
    \item 参与工程检测设备调试与传感器信号采集，协助完成伺服电机测试、线路参数检查与设备运行状态监测，掌握嵌入式检测设备从信号采集到数据处理的基本流程。
    \item 负责实验数据录入、分类汇总与复核，使用 Git 进行技术文档版本管理；配合项目现场开展隧道、桥梁检测工作，了解工程检测流程与传感器设备使用规范。
\end{itemize}
